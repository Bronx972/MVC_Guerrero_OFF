...
namespace MVC_Guerrero.Controllers
{
    public class GradesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GradeID,Description")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GradeID,Description")] Grade grade)
        {
            if (id != grade.GradeID)
            {
                return NotFound();
